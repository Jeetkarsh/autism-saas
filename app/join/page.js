...
export default function Join() {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      try {
        // Store email in localStorage (in real app, would send to backend)
        ...
        <div className="join-container">
          <div className="join-card success-card">
            ...
            <p className="join-subtitle">
              Thank you for joining our waitlist. We&apos;ll send you an email at <strong>{email || localStorage.getItem('waitlist_email')}</strong> as soon as we launch.
            </p>
